...
public class EjercicioSpringBoot3Application {
	
	public static ApplicationContext context;

	public static void main(String[] args) {
		SpringApplication.run(EjercicioSpringBoot3Application.class, args);
		
		context = SpringApplication.run(EjercicioSpringBoot3Application.class, args);
		...
		autor1.setEdad(27);
		autor1.setId(1);
		autor1.setNombre("Santiago Torres");
